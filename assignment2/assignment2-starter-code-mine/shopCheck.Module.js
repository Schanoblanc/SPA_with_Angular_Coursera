(function () {
    ...
    function ToBuyController(checkerService) {
        ...
        toBuyCtrl.valueItem = checkerService.getValueItem();
        toBuyCtrl.refItem = checkerService.getRefItem();
    ...
    function CheckService() {
        ...
        var valueItem = 5;
        var refItem = { value: 5 };
        service.getValueItem = function(){return valueItem};
        service.getRefItem = function(){return refItem};
